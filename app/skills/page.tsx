...
export const metadata: Metadata = {
  title: "SMF Skills | 25 Free + Pro OpenClaw Skills",
  description:
    "25 productivity skills for OpenClaw: 11 free forever + 14 Pro with subscription. File organizers, PDF tools, lead capture, invoicing, booking, and more.",
    ...
    <>
      ...
      <section className="bg-[#001F3F] text-[#E2E8F0] py-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-5">25 Skills for Productivity</h1>
